...
satellite::satellite( unsigned int id_, double m, vector<double> set_q): id{id_}, mass{m}, gen_coord{set_q} {};
...
vector<double> satellite::change_genCoord(vector<double> new_genCoords){
