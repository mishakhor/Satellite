...
vector<double> integrator::calc_force( double m, vector<double> q){
    vector<double> r(3);
...
vector<double> integrator::calc_acceleration(double m, vector<double> q){
    return mult(1/m ,integrator::calc_force(m , q));
}

vector<double> integrator::find_q_deriv(double m, vector<double> q){
...
vector<double> integrator::make_iter_RK(double m, vector<double> q, double step){
